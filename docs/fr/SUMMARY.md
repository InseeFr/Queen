...
- [Découvrir l'application](developer-guide/application.md)
  ...
  - [Spécificité](developer-guide/specificity/specificity.md)
    ...
    - [Mode : autonome ou embarqué](developer-guide/specificity/standalone-embedded.md)
    - [Mode offline : Service-worker](developer-guide/specificity/offline.md)
    - [Mise à jour](developer-guide/specificity/update.md)
    - [Gestion des styles](developer-guide/specificity/styles.md)
  - [Multi-langue](developer-guide/multilanguage.md)
  - [Modèle de données](developer-guide/data-model/data-model.md)
